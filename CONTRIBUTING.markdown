...
* Contribute to the [documentation](https://github.com/eberfreitas/cakephp-slugomatic/tree/gh-pages)
...
Slugomatic tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
...
* [Bug tracker](https://github.com/eberfreitas/cakephp-slugomatic/issues)
